...
<body class="font-sans antialiased bg-[#F5F0E8]">
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 flex flex-col">
            {{-- Top Bar (Mobile) --}}
            <div class="md:hidden bg-[#3E2723] text-white p-4 flex items-center justify-between">
            ...
            <div id="mobileSidebar" class="hidden md:hidden fixed inset-0 z-50">
                ...
                <div class="relative w-64 h-full bg-[#3E2723] text-white flex flex-col">
                    <div class="p-6 border-b border-[#5D4037]">
                        <span class="text-xl font-bold">☕ Aksara Coffe</span>
                    </div>
                    <nav class="flex-1 p-4 space-y-1">
                        <a href="{{ route('admin.dashboard') }}" class="block px-4 py-3 rounded-lg text-sm {{ request()->routeIs('admin.dashboard') ? 'bg-[#6F4E37]' : 'hover:bg-[#4E342E]' }}">Dashboard</a>
                        <a href="{{ route('admin.categories.index') }}" class="block px-4 py-3 rounded-lg text-sm {{ request()->routeIs('admin.categories.*') ? 'bg-[#6F4E37]' : 'hover:bg-[#4E342E]' }}">Kategori</a>
                        <a href="{{ route('admin.menus.index') }}" class="block px-4 py-3 rounded-lg text-sm {{ request()->routeIs('admin.menus.*') ? 'bg-[#6F4E37]' : 'hover:bg-[#4E342E]' }}">Menu</a>
                        <a href="{{ route('admin.settings.edit') }}" class="block px-4 py-3 rounded-lg text-sm {{ request()->routeIs('admin.settings.*') ? 'bg-[#6F4E37]' : 'hover:bg-[#4E342E]' }}">Pengaturan</a>
                    </nav>
                </div>
            </div>
